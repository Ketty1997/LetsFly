    ...
    <div class="containerMio">
      ...
      >
        ...
        <fieldset>
          ...
          <f:input path="name" type="text" placehoder="name" />
        </fieldset>
        <fieldset>
          <f:label path="surname">Surname</f:label>
          <f:input path="surname" type="text" placeholder="surname" />
        </fieldset>
        <fieldset>
        ...
        <div style="text-align: center">
          <a class="errorMessage">${usernameMessage}</a>
        </div>
        <fieldset>
          <a href="/user/editPassword" role="button" id="modifyPassword"
            >Update password</a
          >
        </fieldset>
        <fieldset>
        ...
        <fieldset>
          <a
            href="/user/remove"
            role="button"
            onclick="return confirm('This will delete your account and all your tickets, are you sure?')"
            id="elimina"
            >Delete</a
          >
        </fieldset>
